...
export default function EmailInputWithHistory({ value, onChange, placeholder }) {
  ...
  return (
    <div className="relative flex-1 min-w-0">
      ...
      {open && filtered.length > 0 && (
        <div
          className="absolute left-0 right-0 top-full mt-1 rounded-lg overflow-hidden shadow-lg z-40"
